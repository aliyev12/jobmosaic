<x-layout>
    <div class="bg-white rounded-lg shadow-md w-full md:max-w-xl mx-auto mt-12 p-8 py-12">
        ...
        <form method="POST" action="{{ route('login.authenticate') }}">
            ...
            <button type="submit"
                class="w-full bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded focus:outline-none">Login</button>
            <p class="mt-4 text-gray-500">Don't have an account? <a href="{{ route('register') }}"
                    class="text-blue-900">Register</a></p>
