<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text-area label="Job Description" id="description" name="description" :value="old('description', $job->description)"
            ...
            <x-inputs.text-area label="Requirements" id="requirements" name="requirements" :value="old('requirements', $job->requirements)"
